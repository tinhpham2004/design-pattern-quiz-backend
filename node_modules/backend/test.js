...
async function testGemini() {
  ...
  for (const modelName of modelNames) {
    ...
    try {
      ...
      console.log("Response.response properties:", Object.keys(result.response));
      ...
      if (result.response?.candidates?.[0]?.content?.parts?.[0]?.text) {
        console.log("Response text (from candidates):", result.response.candidates[0].content.parts[0].text);
      } else {
